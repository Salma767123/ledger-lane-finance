...
const CustomerDetail = () => {
  ...
  const [orderHistory, setOrderHistory] = useState([
    { id: 1, orderNo: "SO-001", date: "2024-01-15", amount: 45000, status: "Delivered", items: [{ product: "Product A", quantity: 10, rate: 4500, amount: 45000 }] },
    { id: 2, orderNo: "SO-005", date: "2024-01-10", amount: 32000, status: "Pending", items: [{ product: "Product B", quantity: 8, rate: 4000, amount: 32000 }] },
    { id: 3, orderNo: "SO-008", date: "2024-01-05", amount: 28000, status: "Approved", items: [{ product: "Product C", quantity: 5, rate: 5600, amount: 28000 }] },
    { id: 4, orderNo: "SO-012", date: "2023-12-28", amount: 15000, status: "Delivered", items: [{ product: "Product D", quantity: 3, rate: 5000, amount: 15000 }] }
  ]);

  const [transactionHistory, setTransactionHistory] = useState([
    { id: 1, date: "2024-01-16", type: "Payment", description: "Payment for SO-001", amount: -45000, balance: 0, reference: "PAY-001" },
    { id: 2, date: "2024-01-15", type: "Sales", description: "Sales Order SO-001", amount: 45000, balance: 45000, reference: "SO-001" },
    { id: 3, date: "2024-01-11", type: "Payment", description: "Payment for SO-005", amount: -32000, balance: 0, reference: "PAY-002" },
    { id: 4, date: "2024-01-10", type: "Sales", description: "Sales Order SO-005", amount: 32000, balance: 32000, reference: "SO-005" }
  ]);
  ...
  const handleSendOrder = (order) => {
    toast({
      title: "Order Sent",
      description: `Order ${order.orderNo} has been sent to customer`
    });
  };
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-lg font-semibold">{customer.category}</p>
              </div>
            </div>
          </CardContent>
        </Card>
